...
artscreenEEG 0.6.0 is a MATLAB package to perform basic artifact correction and analysis on electroencephalographic (EEG) data. Please see demo/example_steps.m for an example of how to use the basic functions. 
...
### Version
The newest version of artscreenEEG is 0.6.0 indicating that artscreenEEG is still being developed (version 0)
